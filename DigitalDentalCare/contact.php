...
padding: 20px;box-shadow: 0px 0px 10px 3px red;">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <address>Address:-<br />
          Central Hall,<br />
          Connaught Place (Rajiv Chowk),<br />
          New Delhi,<br />
          Delhi 110001,<br />
          INDIA</address>
        <p>Email:- dento@admin.com</p>
        <p>Phone:- (011) 2345-6781</p>
      </div>
      ...
      <div class="col-md-6">
        <form action="contactcode.php" method="post">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="massage" placeholder="Your Message" rows="7"></textarea>
          </div>
